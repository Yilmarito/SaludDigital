...
const i18n = {
  es: {
    ...
    m5_sub2_title: "♻️ Consumo Responsable de Dispositivos",
  ...
  en: {
    ...
    m5_sub2_title: "♻️ Responsible Device Consumption",
  ...
  m5: (lang) => `
    ...
    <div class="subsection">
      <div class="subsection-title">
        ...
        ${i18n[lang].m5_sub2_title.replace('♻️ ', '')}
      </div>
      <div class="viz-placeholder">♻️
